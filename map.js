function ECUSTMap(id) {
    ...
    _this.msg = function (title, content, img) {
        var msgTitle = "<h4 style='margin:0 0 5px 0;padding:0.2em 0'>" + title + "</h4>";
        var msgImage = "<div class='col-sm-4' style='float: right'><img id='msgImg' style='margin:4px' src='" + img + "' width='150' height='auto'/></div>";
        var msgContent = "<div class='col-sm-8 mapPointText' style='float: left'>" + content + "</div>";

        return "<div class='col-md-12'>" + msgTitle + msgContent + msgImage + "</div>";
    };
